...
I am a **passionate Data Engineer and Analytics Developer** specializing in **low-code and no-code solutions, data analytics, and workflow automation**.  
I build **efficient, scalable pipelines** and **AI-powered tools** to transform raw data into actionable insights for smarter decision-making.  

My expertise includes:  
- **Power Platform (Power BI, Power Automate, Power Apps, Microsoft Fabric)** for end-to-end business analytics and automation.  
- **n8n workflow automation** for orchestrating complex, multi-step processes with ease.  
- **Data analytics and data science** using SQL, PostgreSQL, Python, Pandas, NumPy, and machine learning libraries.  
- **AI and generative solutions** for building intelligent agents, predictive models, and automated workflows.  
- **Low-code/no-code development** to accelerate deployment of business-critical solutions.  

I thrive at the intersection of **data, automation, and AI**, building tools that are **intuitive, actionable, and impactful**.
...
**Link:** [GenAI Document Processor](https://github.com/Yashi101808/AI-DOCUMENT-MS)

---

#### **🛒 Indian-Namkeen-market Research & Analytics**
...
**Link:** [Market Intelligence OSINT Pipeline](https://github.com/Yashi101808/Indian-Namkeen-market)
...
**Link:** [Trip Planning AI Agent](https://github.com/Yashi101808/Trip-Planning-Agent)

---

#### **📊 Trainity Data Analytics Projects**
- Conducted **Daily Life, Car Sales, Bank Loan Risk, Call Center Volume, IMDB, Instagram, Operations, and Hiring analyses**.  
- Focused on uncovering **patterns, trends, and actionable insights** across diverse datasets.  
**Tech:** `Python`, `Pandas`, `SQL`, `Excel`, `Power BI`, `Scikit-learn`  
**Link:** [Trainity Data Analytics Projects](https://github.com/Yashi101808/Data-Analytics-Projects)

---

#### **📈 Sales Analytics Dashboard – Power BI**
- Built a **data-driven sales dashboard** integrating Customer, Product, and Order datasets.  
- Created **interactive visualizations**: drill-down charts, maps, and slicers for revenue & sales trends.  
**Tech:** `Power BI`, `DAX`  
**Link:** [Sales Analytics Dashboard](https://github.com/Yashi101808/Sales_analysis_powerbi)

---

#### **📱 WhatsApp Campaign Automation (n8n + Google Sheets)**
- Developed an **automated WhatsApp messaging pipeline** using n8n with Google Sheets as backend.  
- Implemented **dynamic receiver selection, sender rotation, message logging, and retry logic** every 10 seconds.  
**Tech:** `n8n`, `Google Sheets`, `Workflow Automation`  
**Link:** [WhatsApp Automation Project](https://github.com/Yashi101808/-N8N-Automation-Project)
